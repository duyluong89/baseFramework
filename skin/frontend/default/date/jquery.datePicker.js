	...
	$.extend(
		...
		{	
			...
			setEndDate : function(d)
			{
				...
				var b1 = new Date(this.startDate);
...
//					$('.selectee', this.context).focus();
			...
			_renderCalendar : function()
			{
				...
				var cc = new Date(this.startDate);
				if (this.displayedYear == cc.getFullYear() && this.displayedMonth == this.startDate.getMonth()) {
					...
					var ff = new Date(this.startDate);
					var d = ff.getDate();
					if (d > 20) {
