...
class Paypal extends MX_Controller {
        ...
        function form()
        {
            ...
            $this->paypal_lib->add_field('return', site_url('default/paypal/success'));
            $this->paypal_lib->add_field('cancel_return', site_url('default/paypal/cancel'));
            $this->paypal_lib->add_field('notify_url', site_url('default/paypal/ipn')); // <-- IPN url
