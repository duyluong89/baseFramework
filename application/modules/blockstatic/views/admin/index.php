 ...
 <?php $base =  base_url() . 'skin/backend/default/'; ?>
    ...
    <div class="statsRow">
        <div class="wrapper">
        	<div class="controlB">
            	<ul>
                    <li><a href="<?php echo base_url()?>admin/block/add" title=""><img src="<?php echo $base ?>images/icons/control/32/plus.png" alt="" /><span>Add new user</span></a></li>
<!--                <li><a href="#" title=""><img src="images/icons/control/32/database.png" alt="" /><span>New DB entry</span></a></li>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <tbody>
               <?php if(isset($Blocks) and count($Blocks) > 0): ?>
                <?php foreach($Blocks as $block ): ?>
            <tr class="">
                <td><?php echo $block->id?></td>
                <td><?php echo $block->code?></td>
                <td><?php echo $block->title?></td>
                <td class="center"><a href="<?php echo base_url() . 'admin/block/del/' . $block->id ?>" onclick="return confirm('Do you want to delete block?')" >Del</a>-
                	<a href="<?php echo base_url() . 'admin/block/edit/' . $block->id ?>">edit</a></td>
            </tr>
            <?php endforeach;?>
            <?php endif;?>
            </tbody>
