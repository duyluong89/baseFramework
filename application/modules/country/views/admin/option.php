...
<!--        <div class="nNote nInformation hideit">
        ...
        <!-- Form -->
        <form action="<?php echo base_url()?>country/admin/manager/save" class="form" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $Country['id'] ?>" />
            <input type="hidden" name="status" value="<?php echo $Country['id'] ?>" />
            <fieldset>
                <div class="widget">
                    <div class="title"><img src="<?php echo $base?>images/icons/dark/list.png" alt="" class="titleIcon" /><h6>Country Information</h6></div>
                    <div class="formRow">
                        <label>Name:</label>
                        <div class="formRight"><input type="text" value="<?php echo $Country['name']?>" name="name" /></div>
                        <div class="clear"></div>
                    </div>
                     <div class="formRow">
                        <label>active:</label>
                        <div class="formRight">
                            <input type="checkbox" <?php echo ($Country['active'] == 0)? '':'checked="checked"'  ?>  name="active" id="checkbox1" />
