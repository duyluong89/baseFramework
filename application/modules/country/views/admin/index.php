...
<!--                <li><a href="#" title=""><img src="images/icons/control/32/database.png" alt="" /><span>New DB entry</span></a></li>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <tbody>
               <?php if(isset($Countries) and count($Countries) > 0): ?>
                <?php foreach($Countries as $Country ): ?>
            <tr class="">
                <td><?php echo $Country->id?></td>
                <td><?php echo $Country->name?></td>
                <td class="center"><a href="<?php echo base_url() . 'country/admin/manager/del/' . $Country->id ?>" onclick="return confirm('Do you want to delete country?')" >Del</a>-
                	<a href="<?php echo base_url() . 'country/admin/manager/edit/' . $Country->id ?>">edit</a></td>
            </tr>
            <?php endforeach;?>
            <?php endif;?>
            </tbody>
